...
- red: intenta usar primero una subnet pública de la región; si no existe, define `OBSERVABILITY_SUITE_SUBNET_ID`
...
| `OBSERVABILITY_SUITE_SUBNET_ID` | subnet ID o vacío | No | vacío |
